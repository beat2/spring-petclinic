...
public class OwnerResource
{
  ...
  @RequestMapping(value = "/owner/delete/{ownerId}", method = RequestMethod.DELETE)
  ...
  private ResponseEntity<String> exHandler()
  {
    System.out.println("Got exception");
    return new ResponseEntity<String>("Oops", HttpStatus.NOT_FOUND);
  }
